...
//         Input->BindAction(InputActionMove, ETriggerEvent::Completed, this, &ThisClass::InputMove);
//         Input->BindAction(InputActionMove, ETriggerEvent::Completed, this, &ThisClass::ResetMovementInput);  
//     }
// }
//
// void AMyPawn::DestroyAllScalableActors()
// {
//     if (GEngine)
//     {
//         GEngine->AddOnScreenDebugMessage(-1, 3.0f, FColor::Red,
//             TEXT("Broadcasting destroy event to all subscribers!"));
//     }
//     
//    
...
// }
//
// void AMyPawn::ResetMovementInput(const FInputActionValue& Value)
// {
...
// }
//
// void AMyPawn::InteractWithAllLights()
// {
//     // Знаходимо ВСІ актори що мають Interface
//     TArray<AActor*> FoundActors;
//     UGameplayStatics::GetAllActorsWithInterface(GetWorld(), UInteractableInterface::StaticClass(), FoundActors);
//     
//     // Викликаємо OnInteract для кожного
